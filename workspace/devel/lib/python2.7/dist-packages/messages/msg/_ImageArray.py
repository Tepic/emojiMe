...
"""autogenerated by genpy from messages/ImageArray.msg. Do not edit."""
import sys
...
class ImageArray(genpy.Message):
  _md5sum = "dad93653879502e47043038885f31507"
  _type = "messages/ImageArray"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """sensor_msgs/Image[] ImageArray
================================================================================
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.ImageArray)
      buff.write(_struct_I.pack(length))
      for val1 in self.ImageArray:
        _v1 = val1.header
