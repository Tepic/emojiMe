...
(cl:defmethod cl:initialize-instance :after ((m <ImageArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-msg:<ImageArray> is deprecated: use messages-msg:ImageArray instead.")))

(cl:ensure-generic-function 'ImageArray-val :lambda-list '(m))
(cl:defmethod ImageArray-val ((m <ImageArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-msg:ImageArray-val is deprecated.  Use messages-msg:ImageArray instead.")
  (ImageArray m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ImageArray>) ostream)
  "Serializes a message object of type '<ImageArray>"
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'ImageArray))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'ImageArray))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ImageArray>) istream)
  ...
  (cl:setf (cl:slot-value msg 'ImageArray) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'ImageArray)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ImageArray>)))
  ...
  "dad93653879502e47043038885f31507")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ImageArray)))
  "Returns md5sum for a message object of type 'ImageArray"
  "dad93653879502e47043038885f31507")
